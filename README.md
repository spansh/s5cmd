[![Go Report](https://goreportcard.com/badge/github.com/spansh/s5cmd)](https://goreportcard.com/report/github.com/spansh/s5cmd) ![Github Actions Status](https://github.com/spansh/s5cmd/workflows/CI/badge.svg)
...
The [Releases](https://github.com/spansh/s5cmd/releases) page provides pre-built
...
For macOS, a [homebrew](https://brew.sh) tap is provided:
    ...
    brew tap peak/s5cmd https://github.com/spansh/s5cmd
    brew install s5cmd
...
installed.
    ...
    go get github.com/spansh/s5cmd
...
#### Build
    $ git clone https://github.com/spansh/s5cmd && cd s5cmd
...
an [open ticket](https://github.com/spansh/s5cmd/issues/29) to track the issue.
...
MIT. See [LICENSE](https://github.com/spansh/s5cmd/blob/master/LICENSE).
